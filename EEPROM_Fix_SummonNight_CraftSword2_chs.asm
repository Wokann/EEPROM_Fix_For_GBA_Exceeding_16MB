.gba
.create "./SummonNight_CraftSword2_chs_eepromfix.gba",0x08000000
.close
.open "./SummonNight_CraftSword2_chs.gba","./SummonNight_CraftSword2_chs_eepromfix.gba",0x08000000
