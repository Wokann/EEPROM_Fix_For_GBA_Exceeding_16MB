.gba
.create "./roms/Shin_chan_Aventuras_en_Cineland_eng_eepromfix.gba",0x08000000
.close
.open "./roms/Shin_chan_Aventuras_en_Cineland_eng.gba","./roms/Shin_chan_Aventuras_en_Cineland_eng_eepromfix.gba",0x08000000

gEEPROMConfig               equ 0x0202FE10
EEPROM_SaveAddress          equ 0x0DFFFF00

EEPROM_Type                 equ 0x084856C0
EEPROM_Config512            equ EEPROM_Type + 0xC
EEPROM_Config8k             equ EEPROM_Config512 + 0xC

EEPROMConfigure             equ 0x08097FAC //nothing to hack
DMA3Transfer                equ 0x08097FF4 //nothing to hack
EEPROMRead                  equ 0x08098074 //need to hack
EEPROMWrite1                equ 0x08098124 //nothing to hack
EEPROMWrite                 equ 0x08098138 //need to hack
EEPROMCompare               equ 0x08098298 //nothing to hack
EEPROMWrite1_check          equ 0x080982F0 //nothing to hack
